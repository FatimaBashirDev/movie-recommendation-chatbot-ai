...
export default function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Sign out immediately after signup so name doesn't show
        ...
        <div className="w-full max-w-md bg-black/75 rounded p-16">
          ...
          <form onSubmit={handleEmailSignup} className="space-y-5">
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <label htmlFor="confirm-password-input" className="absolute left-5 top-4 text-base text-[#8c8c8c] pointer-events-none transition-all peer-focus:-translate-y-3 peer-focus:text-xs peer-focus:text-[#8c8c8c] peer-[:not(:placeholder-shown)]:-translate-y-3 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:text-[#8c8c8c]">
                Confirm Password
              </label>
            </div>
          ...
          <div className="mt-8">
            <p className="text-[#8c8c8c] text-base">
              ...
              <Link href="/login" className="text-white hover:text-[#b3b3b3] font-medium">
                Sign in now
              </Link>
            </p>
          </div>
